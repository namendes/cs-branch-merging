...
export default function SelectMenu({branches, selectedBranch, updateBranch}) {
            ...
            <div className="inline-flex divide-x divide-indigo-600 rounded-md shadow-sm">
              <div className="inline-flex divide-x divide-indigo-600 rounded-md shadow-sm">
                <div className="inline-flex items-center rounded-l-md border border-transparent bg-indigo-500 py-2 pl-3 pr-4 text-white shadow-sm">
                  ...
                  {selected && <p className="ml-2.5 text-sm font-medium">{selected.uid}</p>}
                </div>
                    ...
                    {({ selected, active }) => (
                      <div className="flex flex-col">
                        <div className="flex justify-between">
                          <p className={selected ? 'font-semibold' : 'font-normal'}>{option.uid}</p>
                          {selected ? (
